...
from .base_provider import LLMProvider, LLMConfig, ProviderType
    ...
    def create_provider(
        ...
        **config_options
        ...
        if provider_type in ["ollama", "ol"]:
            return LLMProviderFactory._create_ollama_provider(
                base_url, model, **config_options
            )
        elif provider_type in ["lm_studio", "lms", "lm-studio", "lmstudio"]:
            return LLMProviderFactory._create_lm_studio_provider(
                base_url, model, **config_options
            )
        else:
            raise ValueError(
