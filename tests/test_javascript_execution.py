...
console.log(message.trim());'''
    ...
    @patch('os.unlink')
    def test_complex_javascript_temp_file_execution(self, mock_unlink, mock_temp, mock_execute, chat_repl):
...
console.log(greet("World"));'''
        ...
        mock_console.assert_any_call("[dim]Creating temporary javascript file for execution...[/dim]")
